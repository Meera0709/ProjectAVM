...
def click_new():
    ...
    firstname=Label(drugRegistrationWindow,text="First Name:")
    v1=StringVar()
    ...
    lastname=Label(drugRegistrationWindow,text="Last Name:")
    v2=StringVar()
    ...
    #---mobile number entry---
    name_lbl2=Label(drugRegistrationWindow,text="Mobile Number:")
    ...
    name_lbl=Label(drugRegistrationWindow,text="Gender:")
    frm0=Frame(drugRegistrationWindow)
    gender1=IntVar()

    rb1=Radiobutton(frm0,text="M",variable=gender1,value=1)
    rb2=Radiobutton(frm0,text="F",variable=gender1,value=2)
    rb3=Radiobutton(frm0,text="Other",variable=gender1,value=3)
    ...
    #---select DOB spinbox---
    name_lbl3=Label(drugRegistrationWindow,text="Date Of Birth:")
    ...
    #---address entry---
    name_lbl4=Label(drugRegistrationWindow,text="Address:")
    v3=StringVar()
    ...
    #---allergies entry---
    name_lbl5=Label(drugRegistrationWindow,text="Allergies (if any):")
    v4=StringVar()
    ...
    #---doctor ref entry---
    name_lbl6=Label(drugRegistrationWindow,text="Doctor Reference:")
    v5=StringVar()
...
def click_refill():
    ...
    search_lbl=Label(refWindow,text="Enter Mobile Number:")
    ...
    searchButton=Button(refWindow,text="Search",command=refillCommand)
...
def click_pdts():
    ...
    #---searching mobile number---
    search_label1=Label(PdtsWindow,text="Enter Mobile Number:")
    ...
    def PdtsCommand():
        ...
        if refill_validate(mob_num)==True:
            ...
            class Table1:
                def __init__(self,PdWindow):
                    ...
                    for i in range(total_rows):
                        for j in range(total_columns):
                            self.e = Text(pdframe,fg='black', width=18, font=('Times New Roman',8),height=1)
                            self.e.grid(row=i, column=j)
