...
def populate(mobile):
    ...
    RefQuery="SELECT Category,MedicineName,Dosage,Unit,Morning,Afternoon,Evening,Night,NoOfDays from patientPresc where MobileNumber="+mobile
...
def paintPrescriptionWindow(drugDispensingWindow,mobile,dataList):
    ...
    #---SNO---
    SNO=Label(Presc,text="S.NO.")
    SNO.grid(row=1,column=0)

    #---CATEGORY---
    CAT=Label(Presc,text="CATEGORY")
    CAT.grid(row=1,column=1)

    #---MED NAME---
    DRUG=Label(Presc,text="MEDICINE NAME")
    DRUG.grid(row=1,column=2)

    #---DOSAGE---
    DOSE=Label(Presc,text="DOSAGE")
    DOSE.grid(row=1,column=3)

    #---UNIT---
    UNIT=Label(Presc,text="UNIT")
    UNIT.grid(row=1,column=4)

    #---TIMINGS---
    M=Label(Presc,text="TIME OF DAY")
    M.grid(row=1,column=5)

    #---NO. OF DAYS---
    DAYS=Label(Presc,text="DAYS")
    DAYS.grid(row=1,column=6)

    for i in range(1,11):
        SNO1=Label(Presc,text=str(i))
    ...
    FRAME1=Frame(Presc)
    M1=Checkbutton(FRAME1,variable=Checkbutton11,text='M',onvalue=1,offvalue=0)
    A1=Checkbutton(FRAME1,variable=Checkbutton12,text='A',onvalue=1,offvalue=0)
    E1=Checkbutton(FRAME1,variable=Checkbutton13,text='E',onvalue=1,offvalue=0)
    N1=Checkbutton(FRAME1,variable=Checkbutton14,text='N',onvalue=1,offvalue=0)
    ...
    FRAME2=Frame(Presc)
    M2=Checkbutton(FRAME2,variable=Checkbutton21,text='M',onvalue=1,offvalue=0)
    A2=Checkbutton(FRAME2,variable=Checkbutton22,text='A',onvalue=1,offvalue=0)
    E2=Checkbutton(FRAME2,variable=Checkbutton23,text='E',onvalue=1,offvalue=0)
    N2=Checkbutton(FRAME2,variable=Checkbutton24,text='N',onvalue=1,offvalue=0)
    ...
    FRAME3=Frame(Presc)
    M3=Checkbutton(FRAME3,variable=Checkbutton31,text='M',onvalue=1,offvalue=0)
    A3=Checkbutton(FRAME3,variable=Checkbutton32,text='A',onvalue=1,offvalue=0)
    E3=Checkbutton(FRAME3,variable=Checkbutton33,text='E',onvalue=1,offvalue=0)
    N3=Checkbutton(FRAME3,variable=Checkbutton34,text='N',onvalue=1,offvalue=0)
    ...
    FRAME4=Frame(Presc)
    M4=Checkbutton(FRAME4,variable=Checkbutton41,text='M',onvalue=1,offvalue=0)
    A4=Checkbutton(FRAME4,variable=Checkbutton42,text='A',onvalue=1,offvalue=0)
    E4=Checkbutton(FRAME4,variable=Checkbutton43,text='E',onvalue=1,offvalue=0)
    N4=Checkbutton(FRAME4,variable=Checkbutton44,text='N',onvalue=1,offvalue=0)
    ...
    FRAME5=Frame(Presc)
    M5=Checkbutton(FRAME5,variable=Checkbutton51,text='M',onvalue=1,offvalue=0)
    A5=Checkbutton(FRAME5,variable=Checkbutton52,text='A',onvalue=1,offvalue=0)
    E5=Checkbutton(FRAME5,variable=Checkbutton53,text='E',onvalue=1,offvalue=0)
    N5=Checkbutton(FRAME5,variable=Checkbutton54,text='N',onvalue=1,offvalue=0)
    ...
    FRAME6=Frame(Presc)
    M6=Checkbutton(FRAME6,variable=Checkbutton61,text='M',onvalue=1,offvalue=0)
    A6=Checkbutton(FRAME6,variable=Checkbutton62,text='A',onvalue=1,offvalue=0)
    E6=Checkbutton(FRAME6,variable=Checkbutton63,text='E',onvalue=1,offvalue=0)
    N6=Checkbutton(FRAME6,variable=Checkbutton64,text='N',onvalue=1,offvalue=0)
    ...
    FRAME7=Frame(Presc)
    M7=Checkbutton(FRAME7,variable=Checkbutton71,text='M',onvalue=1,offvalue=0)
    A7=Checkbutton(FRAME7,variable=Checkbutton72,text='A',onvalue=1,offvalue=0)
    E7=Checkbutton(FRAME7,variable=Checkbutton73,text='E',onvalue=1,offvalue=0)
    N7=Checkbutton(FRAME7,variable=Checkbutton74,text='N',onvalue=1,offvalue=0)
    ...
    FRAME8=Frame(Presc)
    M8=Checkbutton(FRAME8,variable=Checkbutton81,text='M',onvalue=1,offvalue=0)
    A8=Checkbutton(FRAME8,variable=Checkbutton82,text='A',onvalue=1,offvalue=0)
    E8=Checkbutton(FRAME8,variable=Checkbutton83,text='E',onvalue=1,offvalue=0)
    N8=Checkbutton(FRAME8,variable=Checkbutton84,text='N',onvalue=1,offvalue=0)
    ...
    FRAME9=Frame(Presc)
    M9=Checkbutton(FRAME9,variable=Checkbutton91,text='M',onvalue=1,offvalue=0)
    A9=Checkbutton(FRAME9,variable=Checkbutton92,text='A',onvalue=1,offvalue=0)
    E9=Checkbutton(FRAME9,variable=Checkbutton93,text='E',onvalue=1,offvalue=0)
    N9=Checkbutton(FRAME9,variable=Checkbutton94,text='N',onvalue=1,offvalue=0)
    ...
    FRAME10=Frame(Presc)
    M10=Checkbutton(FRAME10,variable=Checkbutton101,text='M',onvalue=1,offvalue=0)
    A10=Checkbutton(FRAME10,variable=Checkbutton102,text='A',onvalue=1,offvalue=0)
    E10=Checkbutton(FRAME10,variable=Checkbutton103,text='E',onvalue=1,offvalue=0)
    N10=Checkbutton(FRAME10,variable=Checkbutton104,text='N',onvalue=1,offvalue=0)
